            ...
            <div className='cover-container bg-intro text-white '>
                <div className='row align-items-center mr-0'>
                    <div className='col-md-6 col-sm-12 d-flex flex-column align-items-center'>
                        ...
                        <Link type="button" className="btn btn-primary px-5 border border-light w-50 mb-4" to="/signIn">Registrarse</Link>
                        
                        
                        <p>¿Ya tienes una cuenta?</p>
                        <Link type="button" className="btn btn-secondary px-5 marginReg border border-light w-50" to="/login">Iniciar Sesión</Link>
